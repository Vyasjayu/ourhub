...
{/* Top gold glow */} <div className="absolute left-1/2 top-[-180px] h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-[#DFAE45]/[0.055] blur-[120px]" />
    ...
    <div className="relative px-4 pb-36">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[8px] text-white/30">
                {isHindi ? "हमेशा उपलब्ध" : "Always Here"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex items-start gap-3">
          ...
          <div>
            <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#DFAE45]">
              {isHindi ? "दिव्य अनुभव" : "Divine Experience"}
            </p>
            ...
            <p className="mt-1.5 text-[10px] leading-5 text-white/40">
              {isHindi
                ? "अपने घर के आराम से विश्वसनीय पंडितों के साथ पारंपरिक पूजा अनुष्ठानों का अनुभव करें।"
                : "Experience traditional pooja rituals with trusted pandits from the comfort of your home."}
            </p>
          </div>
        </div>
      ...
      <footer className="relative mt-8 pb-3 text-center">
        ...
        <p className="mt-1 text-[8px] tracking-wide text-white/20">
          {isHindi
            ? "दिव्य अनुष्ठान • विश्वसनीय पंडित • मन की शांति"

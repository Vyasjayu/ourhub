...
export default function Page() {
  ...
  const translations = {
    ...
    hi: {
      ...
      brand: "OURHUB पूजा",
      tagline:
        "पवित्र पल। विश्वसनीय सेवाएँ। एक आध्यात्मिक हब।",
    },
  };
          ...
          <section className="mt-4 px-4">
            <div className="grid grid-cols-3 overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.025]">
              ...
              <div className="flex items-center justify-center gap-1.5 px-2 py-3">
                <Star
                  size={14}
                  className="shrink-0 fill-[#DFAE45] text-[#DFAE45]"
                />
          ...
          <section className="mt-9 px-4 pb-5">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="whitespace-nowrap text-[9px] font-bold tracking-[0.28em] text-gray-600">
                  {text.brand}
                </span>

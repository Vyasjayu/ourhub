...
export default function OfflinePoojaPage() {
  return (
    <main className="min-h-screen bg-[#02060A] text-white">
      <div className="relative mx-auto min-h-screen w-full max-w-[480px] overflow-x-hidden bg-[#071424] pb-32">
        {/* =====================================================
            AMBIENT BACKGROUND
        ====================================================== */}
        ...
        <section className="relative z-10 mt-8">
          <SectionHeading
            ...
            title="Book Pooja With Ease"
            description="Choose your pooja, select the location and let our verified pandit handle the rituals."
          />
          ...
          <div className="relative overflow-hidden rounded-[30px] border border-[#DFAE45]/20 bg-gradient-to-br from-[#151D29] via-[#0D1724] to-[#07101A] shadow-[0_20px_60px_rgba(0,0,0,0.3)]">
            ...
            <div className="relative border-b border-white/[0.06] p-5">
              ...
              <p className="mt-3 text-[11px] leading-5 text-slate-500">
                Apni convenience ke according selected temple ya
                apne ghar par pooja book karein.
              </p>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[9px] leading-4 text-slate-500">
                    Mandir ya ghar — selected pooja ka base price
                    clearly show kiya jayega before confirmation.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-white/[0.07] bg-gradient-to-br from-[#101C2A] to-[#08121E] p-5">
            ...
            <div className="relative">
              ...
              <div className="mt-5 grid grid-cols-3 gap-2">
                <CityCard city="Ujjain" />
                <CityCard city="Indore" />
                <CityCard city="Ratlam" />
              </div>
              ...
              <div className="mt-4 flex items-center gap-2 rounded-2xl border border-white/[0.05] bg-black/20 px-3 py-3">
                ...
                <p className="text-[10px] leading-4 text-slate-500">
                  Verified pandits available for home and temple
                  pooja bookings in selected areas.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[30px] border border-[#DFAE45]/20 bg-gradient-to-br from-[#17263A] via-[#101B29] to-[#08121E] p-5 shadow-[0_20px_50px_rgba(0,0,0,0.25)]">
            ...
            <div className="relative">
              ...
              <p className="relative mt-4 text-[11px] leading-5 text-slate-400">
                Pooja booking mein assistance chahiye? Our support
...
function SectionHeading({
  ...
  return (
    <div className="px-4">
      <p className="text-[9px] font-bold uppercase tracking-[0.22em] text-[#DFAE45]">
        {eyebrow}
      </p>
...
function CityCard({ city }: { city: string }) {
  return (
    <div className="rounded-2xl border border-white/[0.06] bg-white/[0.025] px-2 py-3 text-center">
      <MapPin
        size={14}

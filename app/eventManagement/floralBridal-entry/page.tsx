...
const packages = [
  {
    id: "elegant",
    title: "Elegant Floral Entry",
    duration: "30–45 Minutes",
    price: "₹4,999",
    description:
      "A graceful floral bridal entry with beautiful flowers and elegant styling.",
    popular: false,
    features: [
      "Floral entry planning",
      "Fresh / premium artificial flowers",
      "Decorated entry pathway",
      "Music coordination",
      "Bride entry coordination",
      "Photo-ready setup",
    ],
  },
  {
    id: "royal",
    title: "Royal Floral Entry",
    duration: "45–60 Minutes",
    price: "₹7,999",
    description:
      "A grand floral entry designed to create a stunning bridal arrival.",
    popular: true,
    features: [
      "Complete floral entry setup",
      "Premium floral decoration",
      "Decorated bridal pathway",
      "Music & announcement",
      "Entry coordination",
  ...
  {
    id: "luxury",
    title: "Luxury Floral Entry",
    duration: "60–90 Minutes",
    price: "₹11,999",
    description:
      "A customised luxury floral entry with premium styling for a royal wedding.",
    popular: false,
    features: [
      "Custom floral entry concept",
      "Luxury flower styling",
      "Premium entry props",
      "Special lighting coordination",
      "Music & announcement",
...
const floralStyles = [
  {
    icon: Flower2,
    title: "Flower Canopy",
    text: "A beautiful floral canopy for an elegant bride entrance.",
  },
  {
    icon: Crown,
    title: "Royal Floral",
    text: "A grand flower setup designed for a luxury wedding.",
  },
  {
    icon: WandSparkles,
    title: "Floral Pathway",
    text: "Create a magical walkway decorated with beautiful flowers.",
  },
  {
    icon: Sparkles,
    title: "Custom Theme",
    text: "Match flowers and styling with your wedding colour theme.",
  },
];
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-[#DFAE45]/20 bg-[#0A1422] shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
            ...
            <div className="relative -mt-8 px-5 pb-5">
              ...
              <p className="mt-1.5 text-[13px] leading-5 text-white/55">
                Turn the bride's arrival into a breathtaking wedding moment
                with elegant flowers, beautiful styling and coordinated entry
                arrangements.
              </p>
          ...
          <div className="rounded-[24px] border border-[#DFAE45]/15 bg-gradient-to-br from-[#DFAE45]/[0.09] to-transparent p-5">
            ...
            <div className="mt-5 space-y-3">
              ...
              {[
                ...
                "Floral decoration & styling",
                "Decorated entry pathway",
                "Flower canopy / backdrop options",
          ...
          {[
            {
              ...
              text: "Create a stunning first moment as the bride enters the celebration.",
            },
            {
              icon: Sparkles,
              title: "Perfect for Photography",
              text: "A floral setup creates a beautiful backdrop for wedding photographs.",
            },
            {
              icon: Crown,
              title: "Luxury Wedding Feel",
              text: "Add an elegant and premium touch to your wedding entrance.",
            },
          ].map((item) => {
          ...
          {[
            {
              ...
              text: "Select an elegant, royal or customised floral entry.",
            },
            {
              number: "02",
              title: "Share Wedding Details",
              text: "Tell us your wedding date, venue, timing and requirements.",
            },
            {
              number: "03",
              title: "Confirm Your Entry",
              text: "OurHub coordinates the setup and confirms your booking.",
            },
          ].map((step) => (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-[11px] leading-5 text-white/45">
                  OurHub helps coordinate your floral bridal entry so you can
                  enjoy the wedding while we focus on the details.
                </p>
          ...
          <div className="relative overflow-hidden rounded-[26px] border border-[#DFAE45]/20 bg-gradient-to-br from-[#DFAE45]/15 via-[#DFAE45]/5 to-transparent p-5">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-[11px] leading-5 text-white/45">
                Share your wedding details with OurHub and create a floral
                bridal entrance your guests will remember.
              </p>

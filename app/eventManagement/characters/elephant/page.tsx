...
const packages = [
  {
    id: "basic",
    title: "Elephant Appearance",
    duration: "30 Minutes",
    price: "₹1,499",
    description:
      "A fun elephant character appearance for photos, greetings and kids interaction.",
    popular: false,
    features: [
      "Professional elephant character",
      "Kids interaction",
  ...
  },
  {
    ...
    price: "₹1,999",
    description:
      "A complete entertainment experience with games, dance and character interaction.",
    popular: true,
    features: [
      "Professional elephant character",
      "Kids games & interaction",
  ...
  },
  {
    ...
    price: "₹2,499",
    description:
      "Extended character entertainment for a bigger and more memorable celebration.",
    popular: false,
    features: [
      "Professional elephant character",
...
const suitableFor = [
  {
    ...
    text: "Add a unique surprise to your child's special day.",
  },
  {
    icon: PartyPopper,
    title: "Kids Events",
  ...
  },
  {
    ...
    text: "A colourful character experience for kids events.",
  },
  {
    icon: Sparkles,
    title: "Special Events",
    text: "Make celebrations more exciting and memorable.",
  },
];
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-[#DFAE45]/20 bg-[#0A1422] shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
            ...
            <div className="relative aspect-[4/4.2] w-full overflow-hidden">
              ...
              <img
                ...
                alt="Elephant Character Entertainment"
            ...
            <div className="relative -mt-8 px-5 pb-5">
              ...
              <p className="mt-1.5 text-[13px] leading-5 text-white/55">
                Surprise kids and guests with a fun elephant character
                appearance designed to make your celebration memorable.
              </p>
        ...
        <section className="px-4 pt-8">
          ...
          <div className="rounded-[24px] border border-[#DFAE45]/15 bg-gradient-to-br from-[#DFAE45]/[0.09] to-transparent p-5">
            ...
            <div className="mt-5 space-y-3">
              ...
              {[
                "Professional elephant character costume",
                "Friendly kids interaction",
                "Fun games and activities",
                "Dance & entertainment",
                "Photo and selfie moments",
                "Birthday greetings",
                "Professional event artist",
              ].map((item) => (
          ...
          {[
            {
              ...
              text: "Select the elephant entertainment package for your event.",
            },
            {
              number: "02",
              title: "Share Event Details",
              text: "Tell us your event date, time and location.",
            },
            {
              number: "03",
              title: "Confirm Booking",
              text: "OurHub team checks availability and confirms your booking.",
            },
          ].map((step) => (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-[11px] leading-5 text-white/45">
                  ...
                  can enjoy your celebration without the hassle.
                </p>
          ...
          <div className="relative overflow-hidden rounded-[26px] border border-[#DFAE45]/20 bg-gradient-to-br from-[#DFAE45]/15 via-[#DFAE45]/5 to-transparent p-5">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-[11px] leading-5 text-white/45">
                Select your package and contact OurHub to check elephant
                character availability for your event.
              </p>

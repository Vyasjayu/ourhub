...
function PaymentContent() {
  ...
  const panditName = searchParams.get("name") || "";
        ...
        handler: async function (response: any) {
          ...
          if (result.success) {
            ...
            router.push(
              ...
              `/payment-success?paymentId=${response.razorpay_payment_id}&amount=${amount}&minutes=${minutes}&panditId=${panditId}&phone=${panditPhone}&name=${encodeURIComponent(panditName)}`

...
export default function JyotishCheckoutPage() {
    ...
    <main className="min-h-screen bg-[#071321] flex justify-center">
      <div className="w-full max-w-[430px] bg-[#071321] text-white min-h-screen pb-32">
        ...
        <header className="sticky top-0 z-50 h-16 bg-[#081423] border-b border-white/10 flex items-center px-4">
          ...
          <Link href="/religious/jyotish/booking">
            <ArrowLeft />
          </Link>
        ...
        <section className="px-4">
          ...
          <div className="bg-[#0d1b2a] rounded-3xl p-5 space-y-4 border border-white/10">
        ...
        <section className="px-4 mt-6">
          ...
          <div className="bg-[#0d1b2a] rounded-3xl p-5 border border-white/10 space-y-3">

            <div className="flex justify-between">
              <span>Name</span>
              <span>Jayant Vyas</span>
            </div>

            <div className="flex justify-between">
              <span>DOB</span>
              <span>13 Dec 1996</span>
            </div>
        ...
        <section className="px-4 mt-6">
          ...
          <button className="w-full h-14 bg-[#0d1b2a] rounded-2xl border border-white/10 flex items-center justify-between px-4">
            ...
            {[
              ...
              return (
                ...
                <button
                  ...
                  className={`w-full h-14 rounded-2xl border flex justify-between items-center px-4 ${
        ...
        <section className="px-4 mt-6">
          ...
          <div className="bg-[#0d1b2a] rounded-3xl p-5 border border-white/10 space-y-4">
        ...
        <div className="fixed bottom-0 left-0 right-0 flex justify-center bg-[#071321]/95 backdrop-blur">
          ...
          <div className="w-full max-w-[430px] p-4">
            ...
            <Link
              href="/religious/jyotish/payment"

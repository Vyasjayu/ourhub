...
const steps = [
  {
    number: "01",
    title: "Select Pooja",
    description: "Choose the sacred pooja you wish to perform.",
    icon: Flower2,
  },
  {
    number: "02",
    title: "Select Temple",
    description: "Pick your preferred temple and location.",
    icon: Landmark,
  },
  {
    number: "03",
    title: "Pick Date & Time",
    description: "Choose a convenient date and available slot.",
    icon: CalendarDays,
  },
  {
    number: "04",
    title: "Pandit Performs",
    description: "Our verified pandit performs the ritual at the temple.",
    icon: UserRound,
  },
  {
    number: "05",
    title: "Receive Blessings",
    description: "Receive prasad, pooja updates and divine blessings.",
    icon: Gift,
  },
];
...
export default function HowItWorks() {
  return (
    <section className="relative mt-9 px-4">
      {/* Ambient Glow */}
      <div className="pointer-events-none absolute left-1/2 top-16 h-64 w-64 -translate-x-1/2 rounded-full bg-[#DFAE45]/[0.055] blur-3xl" />
      ...
      <div className="relative text-center">
        ...
        <p className="mx-auto mt-2 max-w-[300px] text-[11px] leading-5 text-slate-500">
          A simple and trusted way to arrange sacred rituals at your
          preferred temple.
        </p>
      </div>
...
function ShieldIcon() {
  return (
    <div className="relative">
      <div className="absolute inset-0 rounded-full bg-[#DFAE45]/20 blur-md" />

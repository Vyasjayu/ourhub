...
export default function TechStack() {
  ...
  const t = {
    ...
    description: isHindi
      ? "तेज़, स्केलेबल और बिज़नेस-रेडी डिजिटल एक्सपीरियंस बनाने के लिए चुनी गई मॉडर्न टेक्नोलॉजी।"
      : "Modern technologies selected to build fast, scalable and business-ready digital experiences.",

    builtWithModernTools: isHindi
      ? "मॉडर्न टूल्स के साथ तैयार"
      : "Built with modern tools",

    technologyDescription: isHindi
      ? "परफॉर्मेंस, फ्लेक्सिबिलिटी और ग्रोथ के लिए भरोसेमंद टेक्नोलॉजी।"
    ...
    technologyThatWorks: isHindi
      ? "आपके लिए काम करने वाली टेक्नोलॉजी"
      : "Technology that works for you",

    philosophyDescription: isHindi
      ? "हम आपके प्रोजेक्ट, लक्ष्यों और भविष्य की ग्रोथ के अनुसार सही टेक्नोलॉजी स्टैक चुनते हैं।"
      : "We choose the right stack based on your project, goals and future growth.",

    trustStrip: isHindi
      ? "मॉडर्न स्टैक • क्लीन कोड • स्केलेबल सॉल्यूशंस"
